...
def fit_ont_epoch(net,yolo_losses,epoch,epoch_size,epoch_size_val,gen,genval,Epoch,cuda,writer):
    ...
    torch.save(model.state_dict(), 'logs/608*608/Epoch%d-Total_Loss%.4f-Val_Loss%.4f.pth'%((epoch+1),total_loss/(epoch_size+1),val_loss/(epoch_size_val+1)))
...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(log_dir='./logs/608*608/',flush_secs=60)
    if Cuda:
