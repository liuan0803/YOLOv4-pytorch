...
if __name__ == '__main__':
    img_path = r'/usr/idip/idip/liuan/data/8class_data/test_dataset_8class/7class_CLAHE+3class_org_test'
    save_path = r'/usr/idip/idip/liuan/data/save_txt/yolov4_608*608_aug_double_txt'
